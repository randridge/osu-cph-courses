...
A regression model was fit to predict GPA using these variables. Use the Stata output provided below to answer the questions.
...
A regression model was fit to predict drinking score (`drink`) using year in school and sex. Use the Stata output below to answer the questions.
